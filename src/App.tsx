...
import ComponentArticle from './views/components/Article'
import ImagePreviewer from './views/components/ImagePreviewer'
import ComponentLayout from './views/components/Layout'
    ...
    return (
        ...
        <BrowserRouter>
            ...
            <div>
                ...
                <Route path="/components/imagePreviewer" exact component={ImagePreviewer} />
                <Route path="/components/article" exact component={ComponentArticle} />
                <Route path="/components/switch" exact component={ComponentSwitch} />
                <Route path="/components/layout" exact component={ComponentLayout} />
